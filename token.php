...
try {
 ...
 $sql = "SELECT id, username, email FROM registration WHERE email=?";
 ...
 $token = bin2hex(random_bytes(32));
    ...
    $link = "https://drackahmemorial.com/reset/validateToken.php?token=" . $token;
