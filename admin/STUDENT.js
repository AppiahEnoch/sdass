$(document).ready(function () {
    ...
    function filterStudentSuggestions(inputVal) {
        ...
        var $suggestionList = $('#admin_student_list_suggestion');
            ...
            filteredStudents.forEach(function (student) {
                ...
                $suggestionList.append(
                    $('<li>').addClass('list-group-item')
                              ...
                              .click(function() {
                                  $('#admin_student_list_search_input').val(student.admission_number);
                                  $suggestionList.empty(); // Clear suggestions after selection
                                  // log_student function needs to be defined or replaced with relevant action
    ...
    $('#admin_student_list_search_input').on('input', function () {
        var inputVal = $(this).val();
        filterStudentSuggestions(inputVal);
        $('#admin_student_list_card').toggleClass('d-none', inputVal.length === 0);
    });
});
