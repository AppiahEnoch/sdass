...
try {
    ...
    $sql = "INSERT INTO student_payment (userid, admission_number, payment_type, description, amount, term_year) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("isssds", $user_id, $admission_number, $paymentType, $description, $amount, $term_year);
